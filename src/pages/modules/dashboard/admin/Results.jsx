  ...
  <div className="flex flex-col sm:flex-row justify-between items-center py-4 px-6 bg-white rounded-xl shadow-md">
    ...
    <div className="flex items-center space-x-4">
      ...
      >
        ...
        {/* Adjusted options to fit mock data */}
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Manage and upload student grades and results
              </p>
            </div>
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      >
                        <path
                          ...
                          strokeWidth="2"
                          d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2m-9 0V3h4m-4 2a2 2 0 00-2-2h-2a2 2 0 00-2 2"
                        />
                      </svg>
